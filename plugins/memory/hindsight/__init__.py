...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        # Embedded startup is initiated first; thread startup alone does not
        # guarantee daemon readiness. Keep the operation wrapper for event-loop
        # safety and existing embedded connection recovery.
