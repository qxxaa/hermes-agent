...
def _message_timestamps_enabled(user_config: Optional[dict]) -> bool:
    """Resolve gateway timestamps with an explicit-gateway, then global, default-off policy."""
    from agent.message_timestamps import message_timestamps_enabled

    return message_timestamps_enabled(user_config, messaging_gateway=True)
