...
""".lstrip(),
    ...
    def fake_resolve_runtime_provider(*, requested=None, explicit_base_url=None, explicit_api_key=None,
                                      target_model=None, **_ignored):
        if requested is None:  # the primary, resolved from config.yaml
    ...
    # The auth-failure fallback goes through the shared resolve_runtime_with_fallback walker.
